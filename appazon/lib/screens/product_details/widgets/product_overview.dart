...
import 'package:appazon/screens/product_details/widgets/half_icon.dart';
import 'package:appazon/screens/product_details/widgets/product_image_slider.dart';
                    ...
                    Container(
                      ...
                      child: DropdownMenu(
                        ...
                        dropdownMenuEntries: [
                          for (final variant in widget.product['variants'])
                            DropdownMenuEntry(
                                label: variant[0], value: variant[1])
                        ],
                      ),
                    ),
                ],
